...
Define the user experience for the workflow agent conversation interface, covering message display, tool approval, frame lifecycle, error handling, protocol scoring, input handling, and PDF downloads within the agent chat bubble.
