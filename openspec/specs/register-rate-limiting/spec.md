...
**Purpose**: Prevent automated abuse of the registration endpoint by rate-limiting attempts per email address, matching the existing login controller's protection pattern.
