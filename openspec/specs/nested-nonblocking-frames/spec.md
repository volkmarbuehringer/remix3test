...
How multiple `<Frame>` components can be nested in a hierarchy where each level streams and renders independently, with no frame blocking its parent, siblings, or children.
