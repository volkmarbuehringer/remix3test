...
- Add shared form validation utility in `app/utils/form-errors.ts`:
  ...
  - `function fieldErrorsFromResult(result: ValidationResult): Record<string, string> | undefined` — unwraps fieldErrors or returns undefined
...
- `newapp/app/utils/form-errors.ts` — new shared validation utility (ValidationResult type, fieldErrorsFromResult helper)
...
- `newapp/app/ui/admin-offerings-create-page.tsx` — accept `formValues`/`fieldErrors`/`formError` props, render inline errors, value priority
- `newapp/app/ui/admin-offerings-edit-page.tsx` — accept `formValues`/`fieldErrors`/`formError` props, render inline errors, value priority
- `newapp/app/ui/admin-offerings-page.tsx` — accept and thread new props to form components
