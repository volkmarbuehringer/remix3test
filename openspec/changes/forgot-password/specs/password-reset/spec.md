...
- **AND** the token is passed as a hidden field in the form
...
#### Scenario: Rate limit enforced by IP

- **WHEN** more than 5 requests are made from the same IP within 15 minutes to POST `/auth/forgotten`
