...
The session should be regenerated _before_ writing auth data:
...
- **[Session regeneration]** Regenerating the session discards all existing session data. **Mitigation**: Regenerate _before_ setting auth data, not after.
