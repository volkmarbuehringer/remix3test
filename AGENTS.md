...
This repository uses Remix 3, a web framework for building modern web applications using TypeScript/JavaScript and web standard APIs.

we work only in the newapp project 
...
> **IMPORTANT**: Before ANY code task, load the required context files via @ContextScout 

### Required Context Files

| Task Type      | Context to Load                                            |
| -------------- | ---------------------------------------------------------- |
| Code tasks       | `.opencode/context/core/standards/concepts/code-quality.md` |
| Code Security    | `.opencode/context/core/standards/concepts/security-patterns.md` |
| Code Analysis    | `.opencode/context/core/standards/concepts/code-analysis.md` |
| Remix patterns   | `.opencode/context/development/remix3/navigation.md`       |
| AI features      | `.opencode/context/development/ai/navigation.md`           |
| SSE features     | `.opencode/context/project-intelligence/sse/navigation.md`  |
| Tests            | `.opencode/context/core/standards/concepts/test-coverage.md` |
| Docs             | `.opencode/context/core/standards/concepts/documentation.md` |

### Quick Reference

- **Remix 3 Patterns**: `.opencode/context/development/remix3/guides/`
  - Pagination & Sorting: `pagination.md`, `sorting.md`
  - Forms: `form-patterns.md`
  - Filtering: `filtering.md`
  - SSE: `../sse/guides/sse-implementation.md`, `../sse/guides/sse-event-types.md`
  - Auth: `../auth/guides/auth-middleware.md`, `../auth/guides/session-middleware.md`
- **Remix 3 Auth**: `.opencode/context/development/remix3/auth/guides/`
...
- **Remix 3 Data**: `.opencode/context/development/remix3/data/guides/`
  - Input validation: `input-validation.md`
  - Form data handling: `form-data-handling.md`
  - Database tables: `data-table-schema.md`
  - Database CRUD: `data-table-crud.md`
- **Remix 3 SSE**: `.opencode/context/development/remix3/sse/guides/`
  - Implementation: `sse-implementation.md`
  - Event types: `sse-event-types.md`
  - Offline messaging: `sse-offline-messaging.md`
  - Client-side SSE: `client-side-sse.md`
- **Remix 3 UI**: `.opencode/context/development/remix3/ui/guides/`
  - Layout: `app-layout.md`, `layout.md`, `layout-best-practices.md`
  - Design system: `design-system.md`, `design-system-implementation.md`
  - CSS mixins: `css-mixins.md`, `create-mixins.md`
  - Client interactivity: `client-interactivity-patterns.md`
  - Animation: `animation.md`
- **Project Intelligence (my_app)**: `.opencode/context/project-intelligence/my_app/`
  - Architecture: `concepts/architecture.md`
  - Chat architecture: `concepts/chat-architecture.md`
  - Messages with frames: `guides/messages-with-frames.md`
  - UI component patterns: `guides/ui-component-patterns.md`
  - Client pagination/sort: `guides/client-pagination-sort.md`
- **SSE Demo**: `.opencode/context/project-intelligence/sse/`
  - Encryption: `concepts/e2e-encryption.md`
  - Offline flow: `lookup/offline-message-flow.md`
  - Room broadcasting: `concepts/room-broadcasting.md`
  - Testing: `guides/testing-sse.md`

### When to Load Context

Load context **BEFORE** executing:
