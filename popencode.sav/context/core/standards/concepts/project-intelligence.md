...
**Full Management Guide**: See `.opencode/context/core/standards/concepts/project-intelligence-management.md`
...
- **Reference**: See `.opencode/context/core/context-system/navigation.md` for system overview

## Related Files

- **Management Guide**: `.opencode/context/core/standards/concepts/project-intelligence-management.md`
- **Context System**: `.opencode/context/core/context-system/navigation.md`
