...
/* Before */          /* After */
body {                 body {
  color: #333;           color: var(--rmx-color-text-primary);
  background: #f5f5f5;   background: var(--rmx-surface-lvl0);
}                      }

.btn {                 .btn {
  background: #3498db;   background: var(--rmx-color-action-primary-background);
}                      }
.btn:hover {           .btn:hover {
  background: #2980b9;   background: var(--rmx-color-action-primary-background-hover);
}                      }
```
