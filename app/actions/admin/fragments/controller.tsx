...
export default createController<typeof routes.admin.fragments, AppContext>(routes.admin.fragments, {
      ...
      let activities = [
        {
          id: 1,
          userId: 101,
          action: 'Created a new chat conversation',
          time: new Date(now.getTime() - 30000),
        },
        {
          id: 2,
          userId: 102,
          action: 'Deleted a workflow',
          time: new Date(now.getTime() - 120000),
        },
        {
          id: 3,
          userId: 103,
          action: 'Updated AI agent configuration',
        ...
        { id: 4, userId: 101, action: 'Exported chat log', time: new Date(now.getTime() - 600000) },
        {
          id: 5,
          userId: 104,
          action: 'Modified admin settings',
          time: new Date(now.getTime() - 900000),
        },
        {
          id: 6,
          userId: 102,
          action: 'Ran a new agent process',
