...
const PDF_URL = `${BASE}${routes.verwaltung.pdf.index.href()}`

describe('Verwaltung PDF', () => {
  ...
  it('GET /verwaltung/pdf returns a PDF download for admin', async () => {
  ...
  it('GET /verwaltung/pdf returns 403 for non-admin', async () => {
    let response = await router.fetch(PDF_URL, {
  ...
  it('GET /verwaltung/pdf redirects to login when not authenticated', async () => {
