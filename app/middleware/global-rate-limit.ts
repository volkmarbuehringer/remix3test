        ...
        String(
          html`<!doctype html>
            <html lang="de">
              <head>
                <meta charset="utf-8" />
                <title>Zu viele Anfragen — newapp</title>
                <style>
                  body {
              ...
              <body>
                <div class="card">
                  ...
                  <p>
                    Sie haben in kurzer Zeit zu viele Anfragen gesendet. Bitte warten Sie einen
                    Moment und versuchen Sie es erneut.
                  </p>
                  <p class="retry">Wiederholen in ${retryAfter} Sekunden</p>
                </div>
              </body>
            </html>`,
        ),
