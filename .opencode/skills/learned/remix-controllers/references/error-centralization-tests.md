...
Why existing tests break (in non-obvious ways) when error handling moves from individual controllers into shared middleware. Read this when centralizing body parsing, validation, or auth into middleware and tests unexpectedly fail.
