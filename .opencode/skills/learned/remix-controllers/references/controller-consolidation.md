# Controller Consolidation (Mechanical Process)

## What This Covers

Merging flat kebab-case controller directories into a parent `controller.tsx` as named exports. Read this when `remix doctor` warns "does not match any route map", when related logic is scattered across many small directories, or when a consolidation must not break imports/tests.
