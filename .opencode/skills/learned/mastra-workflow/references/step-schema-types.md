# Step Schema Type Compatibility

## What This Covers

Mastra Workflow's strict TypeScript schema compatibility between steps. Read this when `.parallel()` or `.then()` chains produce `inputSchema`/`outputSchema` type errors.
