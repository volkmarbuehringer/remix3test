...
### MERN (MongoDB, Express, Node)
```
Frontend: development/frontend/ [future]
...
```
Frontend: development/frontend/ + ui/web/ui-styling-standards.md [future]
...
1. `frontend/component-architecture.md` (structure) [future]
2. `frontend/hooks-patterns.md` (logic) [future]
