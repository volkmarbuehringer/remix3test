<!-- Context: project-intelligence/my_app/errors/inline-script-limitations | Priority: high | Version: 1.0 | Updated: 2026-05-03 -->
...
## Related
- `development/remix3/errors/inline-script-limitations.md` — Canonical copy (moved to remix3)
- `development/remix3/guides/client-interactivity-patterns.md` — Pattern selection guide
- `../guides/ui-component-patterns.md` — UI component implementations
- `development/remix3/guides/client-entry-side-effects.md` — Side-effect-only clientEntry
